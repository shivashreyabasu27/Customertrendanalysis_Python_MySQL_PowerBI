...
Database Integration (SQLAlchemy + MySQL) → Loaded cleaned data into MySQL for structured storage and SQL‑based analysis.

Exploratory Data Analysis (SQL) → Queried customer purchase and subscription behavior.
...
Identified top customer segments driving repeat subscriptions.

🚀 How to Run
Clone the repository.

Run Python scripts to extract and clean data.

Use SQLAlchemy to connect to MySQL and load the dataset.
